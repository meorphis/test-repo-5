...
add the following import before your first import `from "MeorphisTest22"`:
...
This can also be useful if you are getting the wrong TypeScript types for `Response` - more details [here](https://github.com/meorphis/test-repo-5/tree/main/src/_shims#readme).
