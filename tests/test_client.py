...
from meorphis_test_22 import MeorphisTest22, AsyncMeorphisTest22, APIResponseValidationError
...
def _get_open_connections(client: MeorphisTest22 | AsyncMeorphisTest22) -> int:
...
class TestMeorphisTest22:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "meorphis_test_22/_legacy_response.py",
                        "meorphis_test_22/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "meorphis_test_22/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: MeorphisTest22) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(MEORPHIS_TEST_22_BASE_URL="http://localhost:5000/from/env"):
            client = MeorphisTest22(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(MEORPHIS_TEST_22_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                MeorphisTest22(api_key=api_key, _strict_response_validation=True, environment="production")
    ...
    def test_base_url_trailing_slash(self, client: MeorphisTest22) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MeorphisTest22) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MeorphisTest22) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = MeorphisTest22(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = MeorphisTest22(base_url=base_url, api_key=api_key, _strict_response_validation=False)
...
class TestAsyncMeorphisTest22:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMeorphisTest22) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MEORPHIS_TEST_22_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMeorphisTest22(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(MEORPHIS_TEST_22_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncMeorphisTest22(api_key=api_key, _strict_response_validation=True, environment="production")
    ...
    def test_base_url_trailing_slash(self, client: AsyncMeorphisTest22) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMeorphisTest22) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMeorphisTest22) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMeorphisTest22(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncMeorphisTest22(base_url=base_url, api_key=api_key, _strict_response_validation=False)
